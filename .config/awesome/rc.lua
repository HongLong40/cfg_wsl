...
globalkeys = gears.table.join(
    ...
    awful.key (
                ...
                {description = "Opera", group = "Apps"}
              ),

    -- browser (private)
    awful.key (
                { modkey, "Control" }, "b",
                function() awful.spawn("opera --private") end,
                {description = "Opera --private", group = "Apps"}
              ),
    ...
    awful.key (
                ...
                {description = "menubar", group = "Apps"}
              ),
...
awful.rules.rules = {
    ...
    -- Set Opera to always map on the tag named "www" on screen 1.
    { rule = {
        class = "Opera", "opera"
      },
